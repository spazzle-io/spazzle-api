...
type Querier interface {
	...
	CreateTreasury(ctx context.Context, arg CreateTreasuryParams) (ServerTreasury, error)
	...
	GetGlobalLeaderboardByWindow(ctx context.Context, arg GetGlobalLeaderboardByWindowParams) ([]GetGlobalLeaderboardByWindowRow, error)
	GetGlobalLeaderboardByWindowCount(ctx context.Context, timeWindow pgtype.Interval) (int64, error)
	...
	GetServerLeaderboardByWindow(ctx context.Context, arg GetServerLeaderboardByWindowParams) ([]GetServerLeaderboardByWindowRow, error)
	GetServerLeaderboardByWindowCount(ctx context.Context, arg GetServerLeaderboardByWindowCountParams) (int64, error)
	...
	GetTreasury(ctx context.Context, address string) (ServerTreasury, error)
	...
	MarkTreasuryDeployed(ctx context.Context, arg MarkTreasuryDeployedParams) (ServerTreasury, error)
	MarkTreasuryDeploying(ctx context.Context, address string) (ServerTreasury, error)
	MarkTreasuryFailed(ctx context.Context, address string) (ServerTreasury, error)
	RecomputeTrendingScores(ctx context.Context, trendingWindow pgtype.Interval) error
	RecoverDeployedTreasury(ctx context.Context, address string) (ServerTreasury, error)

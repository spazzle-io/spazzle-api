...
type ServerTreasuryStatus int32

const (
	ServerTreasuryStatus_SERVER_TREASURY_STATUS_UNSPECIFIED ServerTreasuryStatus = 0
	ServerTreasuryStatus_SERVER_TREASURY_STATUS_PENDING     ServerTreasuryStatus = 1
	ServerTreasuryStatus_SERVER_TREASURY_STATUS_DEPLOYING   ServerTreasuryStatus = 2
	ServerTreasuryStatus_SERVER_TREASURY_STATUS_DEPLOYED    ServerTreasuryStatus = 3
	ServerTreasuryStatus_SERVER_TREASURY_STATUS_FAILED      ServerTreasuryStatus = 4
)

// Enum value maps for ServerTreasuryStatus.
var (
	ServerTreasuryStatus_name = map[int32]string{
		0: "SERVER_TREASURY_STATUS_UNSPECIFIED",
		1: "SERVER_TREASURY_STATUS_PENDING",
		2: "SERVER_TREASURY_STATUS_DEPLOYING",
		3: "SERVER_TREASURY_STATUS_DEPLOYED",
		4: "SERVER_TREASURY_STATUS_FAILED",
	}
	ServerTreasuryStatus_value = map[string]int32{
		"SERVER_TREASURY_STATUS_UNSPECIFIED": 0,
		"SERVER_TREASURY_STATUS_PENDING":     1,
		"SERVER_TREASURY_STATUS_DEPLOYING":   2,
		"SERVER_TREASURY_STATUS_DEPLOYED":    3,
		"SERVER_TREASURY_STATUS_FAILED":      4,
	}
)

func (x ServerTreasuryStatus) Enum() *ServerTreasuryStatus {
	p := new(ServerTreasuryStatus)
	*p = x
	return p
}

func (x ServerTreasuryStatus) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ServerTreasuryStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_gameplay_v1_rpc_server_service_proto_enumTypes[1].Descriptor()
}

func (ServerTreasuryStatus) Type() protoreflect.EnumType {
	return &file_gameplay_v1_rpc_server_service_proto_enumTypes[1]
}

func (x ServerTreasuryStatus) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ServerTreasuryStatus.Descriptor instead.
func (ServerTreasuryStatus) EnumDescriptor() ([]byte, []int) {
...
func (x *ArchiveServerRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ArchiveServerResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type GetServerTreasuryRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ServerId      string                 `protobuf:"bytes,1,opt,name=server_id,json=serverId,proto3" json:"server_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *GetServerTreasuryRequest) Reset() {
	*x = GetServerTreasuryRequest{}
	mi := &file_gameplay_v1_rpc_server_service_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetServerTreasuryRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetServerTreasuryRequest) ProtoMessage() {}

func (x *GetServerTreasuryRequest) ProtoReflect() protoreflect.Message {
	mi := &file_gameplay_v1_rpc_server_service_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetServerTreasuryRequest.ProtoReflect.Descriptor instead.
func (*GetServerTreasuryRequest) Descriptor() ([]byte, []int) {
	return file_gameplay_v1_rpc_server_service_proto_rawDescGZIP(), []int{16}
}

func (x *GetServerTreasuryRequest) GetServerId() string {
	if x != nil {
		return x.ServerId
	}
	return ""
...
type GetServerTreasuryResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Treasury      *ServerTreasury        `protobuf:"bytes,1,opt,name=treasury,proto3" json:"treasury,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetServerTreasuryResponse) Reset() {
	*x = GetServerTreasuryResponse{}
	mi := &file_gameplay_v1_rpc_server_service_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetServerTreasuryResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetServerTreasuryResponse) ProtoMessage() {}

func (x *GetServerTreasuryResponse) ProtoReflect() protoreflect.Message {
	mi := &file_gameplay_v1_rpc_server_service_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetServerTreasuryResponse.ProtoReflect.Descriptor instead.
func (*GetServerTreasuryResponse) Descriptor() ([]byte, []int) {
	return file_gameplay_v1_rpc_server_service_proto_rawDescGZIP(), []int{17}
}

func (x *GetServerTreasuryResponse) GetTreasury() *ServerTreasury {
	if x != nil {
		return x.Treasury
	}
	return nil
...
type ServerTreasury struct {
	...
	Status        ServerTreasuryStatus   `protobuf:"varint,4,opt,name=status,proto3,enum=gameplay.v1.ServerTreasuryStatus" json:"status,omitempty"`
...
func (x *ServerTreasury) Reset() {
	*x = ServerTreasury{}
	mi := &file_gameplay_v1_rpc_server_service_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ServerTreasury) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ServerTreasury) ProtoMessage() {}

func (x *ServerTreasury) ProtoReflect() protoreflect.Message {
	mi := &file_gameplay_v1_rpc_server_service_proto_msgTypes[21]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ServerTreasury.ProtoReflect.Descriptor instead.
func (*ServerTreasury) Descriptor() ([]byte, []int) {
	return file_gameplay_v1_rpc_server_service_proto_rawDescGZIP(), []int{21}
}

func (x *ServerTreasury) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
func (x *ServerTreasury) GetServerId() string {
	if x != nil {
		return x.ServerId
	}
	return ""
...
func (x *ServerTreasury) GetOwnerAddress() string {
	if x != nil {
...
func (x *ServerTreasury) GetStatus() ServerTreasuryStatus {
	if x != nil {
		return x.Status
	}
	return ServerTreasuryStatus_SERVER_TREASURY_STATUS_UNSPECIFIED
}

func (x *ServerTreasury) GetTxHash() string {
	if x != nil {
		return x.TxHash
	}
	return ""
...
func (x *ServerTreasury) GetBlockNumber() int64 {
	if x != nil {
...
func (x *ServerTreasury) GetGasUsed() int64 {
	if x != nil {
		return x.GasUsed
	}
	return 0
...
func (x *ServerTreasury) GetDeployedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.DeployedAt
	}
	return nil
...
func (x *ServerTreasury) GetCreatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (x *ServerTreasury) GetUpdatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.UpdatedAt
	}
	return nil
...
const file_gameplay_v1_rpc_server_service_proto_rawDesc = "" +
	...
	"\x06server\x18\x01 \x01(\v2\x13.gameplay.v1.ServerR\x06server\"D\n" +
	"\x18GetServerTreasuryRequest\x12(\n" +
	"\tserver_id\x18\x01 \x01(\tB\v\xbaH\b\xc8\x01\x01r\x03\xb0\x01\x01R\bserverId\"T\n" +
	"\x19GetServerTreasuryResponse\x127\n" +
	"\btreasury\x18\x01 \x01(\v2\x1b.gameplay.v1.ServerTreasuryR\btreasury\"\x95\x05\n" +
	"\x06Server\x12\x0e\n" +
	...
	"\x11after_total_games\x18\x05 \x01(\x05R\x0fafterTotalGames\"\xb1\x03\n" +
	"\x0eServerTreasury\x12\x18\n" +
	"\aaddress\x18\x01 \x01(\tR\aaddress\x12\x1b\n" +
	"\tserver_id\x18\x02 \x01(\tR\bserverId\x12#\n" +
	"\rowner_address\x18\x03 \x01(\tR\fownerAddress\x129\n" +
	"\x06status\x18\x04 \x01(\x0e2!.gameplay.v1.ServerTreasuryStatusR\x06status\x12\x17\n" +
	"\atx_hash\x18\x05 \x01(\tR\x06txHash\x12!\n" +
	"\fblock_number\x18\x06 \x01(\x03R\vblockNumber\x12\x19\n" +
	"\bgas_used\x18\a \x01(\x03R\agasUsed\x12;\n" +
	...
	"\x16SERVER_SORT_BY_POPULAR\x10\x03*\xd0\x01\n" +
	"\x14ServerTreasuryStatus\x12&\n" +
	"\"SERVER_TREASURY_STATUS_UNSPECIFIED\x10\x00\x12\"\n" +
	"\x1eSERVER_TREASURY_STATUS_PENDING\x10\x01\x12$\n" +
	" SERVER_TREASURY_STATUS_DEPLOYING\x10\x02\x12#\n" +
	"\x1fSERVER_TREASURY_STATUS_DEPLOYED\x10\x03\x12!\n" +
	"\x1dSERVER_TREASURY_STATUS_FAILED\x10\x04B\xad\x01\n" +
...
var file_gameplay_v1_rpc_server_service_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_gameplay_v1_rpc_server_service_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_gameplay_v1_rpc_server_service_proto_goTypes = []any{
	(ServerSortBy)(0),                        // 0: gameplay.v1.ServerSortBy
	(ServerTreasuryStatus)(0),                // 1: gameplay.v1.ServerTreasuryStatus
	(*CreateServerRequest)(nil),              // 2: gameplay.v1.CreateServerRequest
	(*CreateServerResponse)(nil),             // 3: gameplay.v1.CreateServerResponse
	(*GetServerRequest)(nil),                 // 4: gameplay.v1.GetServerRequest
	(*GetServerResponse)(nil),                // 5: gameplay.v1.GetServerResponse
	(*GetServerByNameRequest)(nil),           // 6: gameplay.v1.GetServerByNameRequest
	(*GetServerByNameResponse)(nil),          // 7: gameplay.v1.GetServerByNameResponse
	(*ListServersRequest)(nil),               // 8: gameplay.v1.ListServersRequest
	(*ListServersResponse)(nil),              // 9: gameplay.v1.ListServersResponse
	(*ListUserServersRequest)(nil),           // 10: gameplay.v1.ListUserServersRequest
	(*ListUserServersResponse)(nil),          // 11: gameplay.v1.ListUserServersResponse
	(*GetUserServerPermissionsRequest)(nil),  // 12: gameplay.v1.GetUserServerPermissionsRequest
	(*GetUserServerPermissionsResponse)(nil), // 13: gameplay.v1.GetUserServerPermissionsResponse
	(*UpdateServerRequest)(nil),              // 14: gameplay.v1.UpdateServerRequest
	(*UpdateServerResponse)(nil),             // 15: gameplay.v1.UpdateServerResponse
	...
	(*GetServerTreasuryRequest)(nil),         // 18: gameplay.v1.GetServerTreasuryRequest
	(*GetServerTreasuryResponse)(nil),        // 19: gameplay.v1.GetServerTreasuryResponse
	(*Server)(nil),                           // 20: gameplay.v1.Server
	(*UserServer)(nil),                       // 21: gameplay.v1.UserServer
	(*ListServersCursor)(nil),                // 22: gameplay.v1.ListServersCursor
	(*ServerTreasury)(nil),                   // 23: gameplay.v1.ServerTreasury
...
var file_gameplay_v1_rpc_server_service_proto_depIdxs = []int32{
	20, // 0: gameplay.v1.CreateServerResponse.server:type_name -> gameplay.v1.Server
	20, // 1: gameplay.v1.GetServerResponse.server:type_name -> gameplay.v1.Server
	20, // 2: gameplay.v1.GetServerByNameResponse.server:type_name -> gameplay.v1.Server
	24, // 3: gameplay.v1.ListServersRequest.after_id:type_name -> google.protobuf.StringValue
	25, // 4: gameplay.v1.ListServersRequest.page_size:type_name -> google.protobuf.Int32Value
	0,  // 5: gameplay.v1.ListServersRequest.sort_by:type_name -> gameplay.v1.ServerSortBy
	26, // 6: gameplay.v1.ListServersRequest.after_created_at:type_name -> google.protobuf.Timestamp
	27, // 7: gameplay.v1.ListServersRequest.after_trending_score:type_name -> google.protobuf.DoubleValue
	25, // 8: gameplay.v1.ListServersRequest.after_total_games:type_name -> google.protobuf.Int32Value
	20, // 9: gameplay.v1.ListServersResponse.servers:type_name -> gameplay.v1.Server
	0,  // 10: gameplay.v1.ListServersResponse.sort_by:type_name -> gameplay.v1.ServerSortBy
	22, // 11: gameplay.v1.ListServersResponse.cursor:type_name -> gameplay.v1.ListServersCursor
	26, // 12: gameplay.v1.ListUserServersRequest.after_created_at:type_name -> google.protobuf.Timestamp
	24, // 13: gameplay.v1.ListUserServersRequest.after_id:type_name -> google.protobuf.StringValue
	25, // 14: gameplay.v1.ListUserServersRequest.page_size:type_name -> google.protobuf.Int32Value
	21, // 15: gameplay.v1.ListUserServersResponse.servers:type_name -> gameplay.v1.UserServer
	22, // 16: gameplay.v1.ListUserServersResponse.cursor:type_name -> gameplay.v1.ListServersCursor
	24, // 17: gameplay.v1.UpdateServerRequest.name:type_name -> google.protobuf.StringValue
	24, // 18: gameplay.v1.UpdateServerRequest.stake_per_game:type_name -> google.protobuf.StringValue
	25, // 19: gameplay.v1.UpdateServerRequest.num_rounds_per_game:type_name -> google.protobuf.Int32Value
	25, // 20: gameplay.v1.UpdateServerRequest.round_duration_secs:type_name -> google.protobuf.Int32Value
	25, // 21: gameplay.v1.UpdateServerRequest.num_drawing_options:type_name -> google.protobuf.Int32Value
	20, // 22: gameplay.v1.UpdateServerResponse.server:type_name -> gameplay.v1.Server
	20, // 23: gameplay.v1.ArchiveServerResponse.server:type_name -> gameplay.v1.Server
	23, // 24: gameplay.v1.GetServerTreasuryResponse.treasury:type_name -> gameplay.v1.ServerTreasury
	26, // 25: gameplay.v1.Server.archived_at:type_name -> google.protobuf.Timestamp
	26, // 26: gameplay.v1.Server.created_at:type_name -> google.protobuf.Timestamp
	26, // 27: gameplay.v1.UserServer.archived_at:type_name -> google.protobuf.Timestamp
	26, // 28: gameplay.v1.UserServer.created_at:type_name -> google.protobuf.Timestamp
	26, // 29: gameplay.v1.ListServersCursor.after_created_at:type_name -> google.protobuf.Timestamp
	1,  // 30: gameplay.v1.ServerTreasury.status:type_name -> gameplay.v1.ServerTreasuryStatus
	26, // 31: gameplay.v1.ServerTreasury.deployed_at:type_name -> google.protobuf.Timestamp
	26, // 32: gameplay.v1.ServerTreasury.created_at:type_name -> google.protobuf.Timestamp
	26, // 33: gameplay.v1.ServerTreasury.updated_at:type_name -> google.protobuf.Timestamp

...
const file_auth_v1_service_auth_proto_rawDesc = "" +
	"\n" +
	"\x1aauth/v1/service_auth.proto\x12\aauth.v1\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\"auth/v1/rpc_get_siwe_payload.proto\x1a\x1eauth/v1/rpc_authenticate.proto\x1a%auth/v1/rpc_verify_access_token.proto\x1a&auth/v1/rpc_refresh_access_token.proto\x1a'auth/v1/rpc_revoke_refresh_tokens.proto2\x90\n" +
	"\n" +
	...
	"\n" +
	"\n" +
	"\x06bearer\x12\x00\x82\xd3\xe4\x93\x02\x1c\"\x1a/auth/refresh-access-token\x12\xe3\x01\n" +
	...
	"\n" +
	"\n" +
	"\x06bearer\x12\x00\x82\xd3\xe4\x93\x02\x1d\"\x1b/auth/revoke-refresh-tokensB\xaf\x02\x92A\x9b\x01\x120\n" +
	"\fAuth Service\"\x1d\n" +

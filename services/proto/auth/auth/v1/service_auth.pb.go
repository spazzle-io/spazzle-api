...
const file_auth_v1_service_auth_proto_rawDesc = "" +
	...
	"\n" +
	"x-internal\x12\x02 \x01\x82\xd3\xe4\x93\x02\x17:\x01*\"\x12/auth/authenticate\x12\xcf\x01\n" +
	"\x11VerifyAccessToken\x12!.auth.v1.VerifyAccessTokenRequest\x1a\".auth.v1.VerifyAccessTokenResponse\"s\x92AL\x12\x13Verify access token\x1a'Verify whether an access token is validb\f\n" +
	"\n" +
	"\n" +

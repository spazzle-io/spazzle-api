...
const file_users_v1_service_users_proto_rawDesc = "" +
	"\n" +
	"\x1cusers/v1/service_users.proto\x12\busers.v1\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x1eusers/v1/rpc_create_user.proto2\x92\x01\n" +
	"\fUsersService\x12\x81\x01\n" +
	"\n" +
	"CreateUser\x12\x1b.users.v1.CreateUserRequest\x1a\x1c.users.v1.CreateUserResponse\"8\x92A$\x12\rCreate a user\x1a\x11Create a new userb\x00\x82\xd3\xe4\x93\x02\v:\x01*\"\x06/usersB\xb7\x02\x92A\x9c\x01\x121\n" +
	"\rUsers Service\"\x1d\n" +
...
var file_users_v1_service_users_proto_depIdxs = []int32{
	...
	1, // 1: users.v1.UsersService.CreateUser:output_type -> users.v1.CreateUserResponse

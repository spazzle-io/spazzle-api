...
const file_users_v1_service_user_proto_rawDesc = "" +
	"\n" +
	"\x1busers/v1/service_user.proto\x12\busers.v1\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x1fusers/v1/rpc_user_service.proto2\xf3\x06\n" +
	...
	"\n" +
	"\n" +
	"\x06bearer\x12\x00\x82\xd3\xe4\x93\x02\x10:\x01*2\v/users/{id}B\xb6\x02\x92A\x9c\x01\x121\n" +
	"\rUsers Service\"\x1d\n" +
...
var file_users_v1_service_user_proto_goTypes = []any{
	...
	(*GetUserByWalletAddressResponse)(nil), // 7: users.v1.GetUserByWalletAddressResponse
...
func file_users_v1_service_user_proto_init() {
	...
	file_users_v1_rpc_user_service_proto_init()
	type x struct{}
